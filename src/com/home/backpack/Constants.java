...
public final class Constants {
    ...
    public static final String ITEM_WEIGHT = "Введите, пожалуйста, вес предмета #";
    public static final String ITEM_COST = "Введите, пожалуйста, стоимость предмета #";
    public static final String INCORRECT_INPUT = "Некорректный ввод. Пожалуйста, введите неотрицательное целое число";
